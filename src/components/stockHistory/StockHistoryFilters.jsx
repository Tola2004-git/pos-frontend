...
export function StockHistoryFilters({
  ...
  const ACTION_OPTIONS = [
    ...
    { value: "sale", label: t.actionLabelSale },
    { value: "cancel_restore", label: t.actionLabelRestored },
    { value: "refund_restore", label: t.actionLabelRefundRestore },
  ];
  ...
  return (
    ...
    >
      ...
      >
        <SearchNormal1 size={18} color="currentColor" variant="outline" className="text-white" />
        <input
          type="text"
